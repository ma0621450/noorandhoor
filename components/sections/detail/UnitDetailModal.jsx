...
function DetailRow({ label, value }) {
  ...
  return (
    <div className="flex items-start justify-between gap-4 border-b border-white/8 py-3 last:border-b-0">
      ...
      <dd className="m-0 text-right text-sm font-medium text-white">{value}</dd>
    </div>
  );
}
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-3 sm:p-6">
      ...
      <div
        ...
        className="relative grid max-h-[92vh] w-full max-w-[980px] overflow-hidden rounded-2xl border border-[#ba8a44]/25 bg-[#161616] shadow-2xl lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]"
      >
        <div className="relative min-h-[240px] bg-[#1a1a1a] lg:min-h-full">
          {unit.planImage ? (
            <MediaImage
              src={unit.planImage}
        ...
        <div className="relative flex max-h-[92vh] flex-col overflow-y-auto p-5 sm:p-7">
          <button
            type="button"
            aria-label="Close"
            onClick={onClose}
