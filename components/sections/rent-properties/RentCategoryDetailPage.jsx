...
export default async function RentCategoryDetailPage({ categoryKey, params }) {
  ...
  return (
    <div className="relative w-full overflow-x-clip bg-[#111111] text-white">
      <DetailHeader
        property={property}
        breadcrumbLabel={category.eyebrow}
      ...
      <DetailRelated
        ...
        heading="Explore Similar Rent Properties"
