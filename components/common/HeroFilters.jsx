...
function ResetFiltersButton({ disabled, onReset }) {
  return (
    <button
      ...
      onClick={onReset}
      disabled={disabled}
      className="self-center text-xs font-semibold uppercase tracking-[1.3px] text-[#eec876] transition hover:text-[#f5f5f5] disabled:cursor-not-allowed disabled:opacity-40 lg:self-auto"
    >
      Reset filters
    </button>
  );
